...
enum {
	...
	ARROW, ASAND, ASXOR, ASLSHIFT, ASM, ASMINUS, ASMOD, ASOR, ASPLUS,
...
enum {
	...
	OP_BINXOR, OP_BOOL, OP_BRFALSE, OP_BRTRUE, OP_CALL, OP_CALLFAR, 
	OP_CALR,OP_COMMA, OP_DEC, OP_DIV, OP_EQUAL, OP_GREATER, OP_GTEQ,
