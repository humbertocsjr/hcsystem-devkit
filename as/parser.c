...
void parse()
{
    ...
    else
    {
        ...
        if(is(curr(), "far"))
        {
            strlcat(mnemonic, " far", MNEMONIC_MAX);
            next();
        }
        else if(is(curr(), "near"))
        {
            strlcat(mnemonic, " near", MNEMONIC_MAX);
            next();
        }
        else if(is(curr(), "short"))
        {
            strlcat(mnemonic, " short", MNEMONIC_MAX);
            next();
        }
        else if(is(curr(), "word"))
        {
            strlcat(mnemonic, " word", MNEMONIC_MAX);
            next();
        }
        else if(is(curr(), "byte"))
        {
            strlcat(mnemonic, " byte", MNEMONIC_MAX);
            next();
        }
