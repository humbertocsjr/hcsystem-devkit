...
opcode_t _opcodes[] = 
{
    ...
    {"ssb", "ssb word", {ARG_AX, ARG_VALUE, ARG_NONE}, {0x1d}, emit_none_value16},
    {"ssb", "ssb byte", {ARG_AL, ARG_VALUE, ARG_NONE}, {0x1c}, emit_none_value8},
    {"ssb", "ssb word", {ARG_16BIT, ARG_16BIT, ARG_NONE}, {0x19, 0xc0}, emit_mrm_reg_reg},
    {"ssb", "ssb byte", {ARG_8BIT, ARG_8BIT, ARG_NONE}, {0x18, 0xc0}, emit_mrm_reg_reg},
    {"ssb word", 0, {ARG_PTR, ARG_VALUE, ARG_NONE}, {0x81, 0x18}, emit_mrm_ptr_value16},
    {"ssb byte", 0, {ARG_PTR, ARG_VALUE, ARG_NONE}, {0x80, 0x18}, emit_mrm_ptr_value8},
    {"ssb", "ssb word", {ARG_16BIT, ARG_PTR, ARG_NONE}, {0x1b, 0x00}, emit_mrm_reg_ptr},
    {"ssb", "ssb byte", {ARG_8BIT, ARG_PTR, ARG_NONE}, {0x1a, 0x00}, emit_mrm_reg_ptr},
    {"ssb", "ssb word", {ARG_PTR, ARG_16BIT, ARG_NONE}, {0x19, 0x00}, emit_mrm_ptr_reg},
    {"ssb", "ssb byte", {ARG_PTR, ARG_8BIT, ARG_NONE}, {0x18, 0x00}, emit_mrm_ptr_reg},
